  ...
  routes: [
    ...
    { path: '/admin/login', name: 'AdminLogin', component: () => import('../views/AdminLoginView.vue'), meta: { title: 'Admin Login' } },
    {
      ...
      children: [
        ...
        { path: 'crs-rates', name: 'AdminCrsRates', component: () => import('../views/admin/AdminCrsRatesView.vue'), meta: { title: 'Rates' } },
        { path: 'crs-channels', name: 'AdminCrsChannels', component: () => import('../views/admin/AdminCrsChannelsView.vue'), meta: { title: 'Channels' } },
        { path: 'crs-availability', name: 'AdminCrsAvailability', component: () => import('../views/admin/AdminCrsAvailabilityView.vue'), meta: { title: 'Availability' } },
        { path: 'crm-campaigns', name: 'AdminCrmCampaigns', component: () => import('../views/admin/AdminCrmCampaignsView.vue'), meta: { title: 'CRM Campaigns' } },
        { path: 'crm-loyalty', name: 'AdminCrmLoyalty', component: () => import('../views/admin/AdminCrmLoyaltyView.vue'), meta: { title: 'CRM Loyalty' } },
        { path: 'crm-communications', name: 'AdminCrmCommunications', component: () => import('../views/admin/AdminCrmCommunicationsView.vue'), meta: { title: 'CRM Communications' } },
        ...
        { path: 'maintenance-requests', name: 'AdminMaintenanceRequests', component: () => import('../views/admin/AdminMaintenanceRequestsView.vue'), meta: { title: 'Maintenance Requests' } },
        { path: 'maintenance-schedule', name: 'AdminMaintenanceSchedule', component: () => import('../views/admin/AdminMaintenanceScheduleView.vue'), meta: { title: 'Maintenance Schedule' } },
        { path: 'maintenance-inventory', name: 'AdminMaintenanceInventory', component: () => import('../views/admin/AdminMaintenanceInventoryView.vue'), meta: { title: 'Maintenance Inventory' } },
        { path: 'reports', name: 'AdminReports', component: () => import('../views/admin/AdminReportsView.vue'), meta: { title: 'Reports' } },
        { path: 'audit-log', name: 'AdminAuditLog', component: () => import('../views/admin/AdminAuditLogView.vue'), meta: { title: 'Audit log' } },
        { path: 'users', name: 'AdminUsers', component: () => import('../views/admin/AdminUsersView.vue'), meta: { title: 'User management' } },
        { path: 'login-activity', name: 'AdminLoginActivity', component: () => import('../views/admin/AdminLoginActivityView.vue'), meta: { title: 'Login activity' } },
        { path: 'security', name: 'AdminSecurity', component: () => import('../views/admin/AdminSecurityView.vue'), meta: { title: 'Security' } },
        { path: 'analytics-kpi', name: 'AdminAnalyticsKpi', component: () => import('../views/admin/AdminAnalyticsKpiView.vue'), meta: { title: 'KPIs' } },
      ],
    },
