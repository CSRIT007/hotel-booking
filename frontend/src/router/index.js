  ...
  routes: [
    ...
    { path: '/admin/login', name: 'AdminLogin', component: () => import('../views/AdminLoginView.vue'), meta: { title: 'Admin Login' } },
    {
      ...
      children: [
        ...
        { path: 'finance-revenue', name: 'AdminFinanceRevenue', component: () => import('../views/admin/AdminPlaceholder.vue'), meta: { title: 'Revenue' } },
        { path: 'finance-expense', name: 'AdminFinanceExpense', component: () => import('../views/admin/AdminPlaceholder.vue'), meta: { title: 'Expenses' } },
        { path: 'finance-profit', name: 'AdminFinanceProfit', component: () => import('../views/admin/AdminPlaceholder.vue'), meta: { title: 'Profit' } },
